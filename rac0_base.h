...
// cpu
#define RAC0_HALT_OPCODE        ((rac0_opcode_t) 1)
...
// memory
#define RAC0_STORE_OPCODE       ((rac0_opcode_t) 19)
...
// arithmetic
#define RAC0_ADD_OPCODE         ((rac0_opcode_t) 23)
...
// logic
#define RAC0_CMP_OPCODE         ((rac0_opcode_t) 28)
...
// flow
#define RAC0_JMPA_OPCODE        ((rac0_opcode_t) 36)
...
// device
#define RAC0_SETDA_OPCODE       ((rac0_opcode_t) 42)
...
// interrupt
#define RAC0_INT_OPCODE         ((rac0_opcode_t) 48)
#define RAC0_IRET_OPCODE        ((rac0_opcode_t) 49)
