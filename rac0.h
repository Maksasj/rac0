...
#define RAC0_JMPLUA_OPCODE      ((rac0_opcode_t) 16)
#define RAC0_JMPLDA_OPCODE      ((rac0_opcode_t) 17)

#define RAC0_SETDA_OPCODE       ((rac0_opcode_t) 18)
#define RAC0_SETDT_OPCODE       ((rac0_opcode_t) 19)
#define RAC0_POOLDA_OPCODE      ((rac0_opcode_t) 20)
#define RAC0_POOLDT_OPCODE      ((rac0_opcode_t) 21)
#define RAC0_PUSHDA_OPCODE      ((rac0_opcode_t) 22)
#define RAC0_PUSHDT_OPCODE      ((rac0_opcode_t) 23)

#define RAC0_WAIT_OPCODE        ((rac0_opcode_t) 24)
